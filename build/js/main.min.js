...
var _swiperTrainers = require("./modules/swiper-trainers");
var _swiperReviews = require("./modules/swiper-reviews");
var _video = require("./modules/video");
var _initTabs = require("./modules/init-tabs");
var _initModal = require("./modules/init-modal");
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  window.addEventListener('load', function () {
    ...
    // window.form = form;
    // form.init();
    (0, _swiperTrainers.initTrainersSwiper)();
...
},{"./modules/init-modal":3,"./modules/init-tabs":4,"./modules/swiper-reviews":6,"./modules/swiper-trainers":7,"./modules/video":9,"./utils/ios-vh-fix":11}],2:[function(require,module,exports){
"use strict";
...
function sendForm() {
  if (form) {
    form.addEventListener('submit', function (event) {
      ...
      if ((0, _formValidation.validateForm)(form) === true) {
...
},{"./form-validation":2,"./message":5}],4:[function(require,module,exports){
"use strict";
...
},{"./tabs":8}],5:[function(require,module,exports){
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.showMessage = exports.showErrorMessage = void 0;
...
var showMessage = function showMessage() {
  if (templateSuccess) {
    var successSubmitMessage = templateSuccess.content.querySelector('.success').cloneNode(true);
    var onCloseMessageClick = function onCloseMessageClick() {
...
var showErrorMessage = function showErrorMessage() {
  if (templateError) {
    var errorSubmitMessage = templateError.content.querySelector('.error').cloneNode(true);
    var onErrorMessageClick = function onErrorMessageClick() {
      errorSubmitMessage.remove();
      body.style.overflow = 'scroll';
      document.removeEventListener('keydown', onErrorMessageEscKeydown);
      errorSubmitMessage.removeEventListener('click', onErrorMessageClick);
    };
    var onErrorMessageEscKeydown = function onErrorMessageEscKeydown(evt) {
      if (evt.key === 'Escape') {
        evt.preventDefault();
        onErrorMessageClick();
      }
...
},{"../vendor/swiper":12}],7:[function(require,module,exports){
"use strict";
...
var initTrainersSwiper = function initTrainersSwiper() {
  if (trainersSwiper) {
    new _swiper.default('.trainers__swiper', {
      direction: 'horizontal',
      loop: true,
      navigation: {
        nextEl: '.swiper-button-next',
...
},{"../vendor/swiper":12}],8:[function(require,module,exports){
"use strict";
